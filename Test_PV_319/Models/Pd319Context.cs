...
public partial class Pd319Context : DbContext
{
    public Pd319Context()
    {
    }

    public Pd319Context(DbContextOptions<Pd319Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(localdb)\\Local;Initial Catalog=PD_319;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Group>(entity =>
        {
            ...
            entity.HasMany(d => d.Discipline).WithMany(p => p.Groups)
                .UsingEntity<Dictionary<string, object>>(
                    "CompleteDiscipline",
                    r => r.HasOne<Discipline>().WithMany()
                        .HasForeignKey("Discipline")
